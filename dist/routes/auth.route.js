...
const upload_profile_1 = __importStar(require("../middlewares/upload-profile"));
...
router.post('/register', (0, rate_limit_middleware_1.rateLimit)({ windowMs: 15 * 60 * 1000, max: 30, keyPrefix: "register" }), upload_profile_1.default.none(), authController.registerUser);
router.post('/login', (0, rate_limit_middleware_1.rateLimit)({ windowMs: 15 * 60 * 1000, max: 30, keyPrefix: "login" }), authController.loginUser);
router.post('/logout', authController.logoutUser);
router.get('/me', authorized_middleware_1.authorizedMiddleWare, authController.getCurrentUser);
router.post("/me/profile-picture", authorized_middleware_1.authorizedMiddleWare, upload_profile_1.uploadSingleProfileImage, authController.uploadMyProfilePicture);
